...
label .section_1:
    ...
    hide example
    show example lesson_03_01a large
    ...
    call screen lesson_test_screen(
        obj = lesson_03.Example_1('eileen happy'),
...
label .section_2:
    ...
    hide example
    show example lesson_03_03b large
    ...
    call screen lesson_test_screen(
        obj = lesson_03.Example_2('eileen happy', 200),
        desc = _("Press the arrow keys to move."),
        close = True
    )
...
label .section_3:
    ...
    show example lesson_03_04a small
    ...
    call screen lesson_test_screen(
        obj = lesson_03.Example_3('eileen happy', 200),
        desc = _("Press the arrow keys to move."),
        close = True
    )
