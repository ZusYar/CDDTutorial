python early:
    ...
    def execute_example(data):
        ...
        if not hide:
            renpy.show_screen("example", names, example_size == "small", example_location == "top", showtrans=showtrans)
...
init python:
    ...
    import re
    import game.renpy.keywords as keywords
...
screen example(blocks, small=False, top=False, showtrans=False):
